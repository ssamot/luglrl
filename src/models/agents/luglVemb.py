...
class LUGLVLightGBM(DCLF):
    ...
    def get_model_qs(self, state_features, legal_actions):
        ...
        actions = []
        terminal = []
        parent = [ord(c) for c in str(self.state).split(":")[-1]]
        ...
        actions = np.asarray(self.transformer.transform(np.array(actions)))
    ...
    def train_supervised(self):
        ...
        transformer = GradientBoostingFeatureGenerator(n_estimators = 100, stack_to_X=False,regression=True)
